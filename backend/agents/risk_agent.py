"""
RiskAgent — Classifies issue urgency and ranks garages by score.
Factors: distance (40%), rating (30%), specialization (20%), availability (10%).
"""
import math
from typing import List

from models.models import DB, Garage, Vehicle, SERVICE_DETAILS, Urgency


class RiskAgent:
    def assess_risk(self, confidence: float, prediction: str) -> str:
